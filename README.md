...
- [The Stall](https://the-stall.intuitek.ai) — **172 pay-per-call data tools** via MCP + x402 on Base: US stocks, ETF holdings, crypto sentiment, DeFi yields, options chains (CBOE), Solana tx intel, sanctions screening (OFAC), macro indicators, congressional trades, insider filings, clinical trials, NPI provider lookup, and more. $0.001–$1.50 USDC per call. No API keys, no signup. CDP Bazaar indexed. ([MCP](https://the-stall.intuitek.ai/mcp) | [Health](https://the-stall.intuitek.ai/health) | [GitHub](https://github.com/thebrierfox/the-stall) | [Registry](https://registry.modelcontextprotocol.io/servers/ai.intuitek.the-stall) | [Glama](https://glama.ai/mcp/servers/thebrierfox/the-stall))
