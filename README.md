[Resource from claude.ai GitHub at repo://xpaysh/awesome-x402/sha/6440a1c9542bcad6689bcd45b9b671ad06f2b1b3/contents/README.md] # Awesome X402 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- [YIELD INTELLIGENCE MCP](https://api.intuitek.ai/yield/mcp) - Passive income opportunity analysis with live US Treasury rates, portfolio yield calculator, and AI-powered income optimization for autonomous agents. 2 tools: `analyze_yield_opportunities`, `optimize_income_portfolio`. Open endpoint, no auth required. $1 USDC per call via x402 on Base. Official MCP registry: `io.github.thebrierfox/intuitek-ace`. ([GitHub](https://github.com/thebrierfox/intuitek-ace)) | ([A2A Agent Card](https://api.intuitek.ai/.well-known/agent.json))
### Agent Frameworks
